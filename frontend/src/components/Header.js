    ...
    <nav className="navbar">
      <div className="nav-container">
        ...
        <ul className="nav-menu" id="navMenu">
          ...
          >
            <Link to="/location" className="nav-link" onClick={closeMobileMenu}>
              Location Service
            </Link>

            <div
              className={`dropdown-menu ${
                activeDropdown === "test1" ? "show" : ""
              }`}
            >
              <Link to="/location" className="dropdown-item" onClick={closeMobileMenu}>
                Live Location
              </Link>
        ...
        <div className="nav-actions">
          {user ? (
            ...
            <Link to="/" className="">
              <button className="cta-button">Sign Out</button>
            </Link>
          )}
        </div>
      </div>
