...
function SignUp() {
    ...
    const checkPasswordStrength = (password) => {
        ...
        let color = '#e53e3e';
        if (score >= 7) { strengthLevel = 'Very Strong'; color = '#0b5648'; }
        else if (score >= 6) { strengthLevel = 'Strong'; color = '#8cdb66'; }
        else if (score >= 4) { strengthLevel = 'Medium'; color = '#f6ad55'; }
        else if (score >= 2) { strengthLevel = 'Weak'; color = '#fc8181'; }
        return { score: Math.min(score, 5), feedback, strengthLevel, color };
    };
                        ...
                        {formData.password && (
                            <div className="password-strength-container">
                                <div className="strength-meter">
                                    <div className="strength-meter-fill" style={{ width: `${(passwordStrength.score / 5) * 100}%`, backgroundColor: passwordStrength.color }}></div>
                                </div>
                                <div className="strength-info">
                                    <span className="strength-level" style={{ color: passwordStrength.color }}>{passwordStrength.strengthLevel}</span>
