...
function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://localhost:8070/auth/verify-otp', { email: form.email, otp: form.otp });
            const res = await axios.post('http://localhost:8070/auth/reset-password', form);
